...
def generateResponse(userInput,sentences,askResponseDict,ql,similarityThredhold=0.7):
    ...
    if(vals[0][idx]<similarityThredhold):
        response=["Your input keywords donot exist in my knowledge","That's a good question ","Sorry, I don't understand","I don't rightly know","I don't have that in my program"]
        r=ran.randint(0,4)
